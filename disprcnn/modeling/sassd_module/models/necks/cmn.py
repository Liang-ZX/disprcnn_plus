...
from disprcnn.modeling.sassd_module.ops.pointnet2 import pointnet2_utils
import torch
from disprcnn.modeling.sassd_module.ops import pts_in_boxes3d
from disprcnn.modeling.sassd_module.core.loss.losses import weighted_smoothl1, weighted_sigmoid_focal_loss
from disprcnn.modeling.sassd_module.core import tensor2points
...
class SpMiddleFHD(nn.Module):
    ...
    def build_aux_target(self, nxyz, gt_boxes3d, enlarge=1.0):
        ...
        for i in range(len(gt_boxes3d)):
            ...
            # from disprcnn.modeling.sassd_module.datasets.kitti_utils import draw_lidar, draw_gt_boxes3d
