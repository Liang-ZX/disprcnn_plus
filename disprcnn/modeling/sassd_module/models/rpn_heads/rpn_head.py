...
from disprcnn.modeling.sassd_module.ops.iou3d.iou3d_utils import nms_gpu, boxes3d_to_bev_torch
from disprcnn.modeling.sassd_module.core import (AnchorGenerator, anchor_target, delta2bbox, delta2rbbox3d, add_sin_difference,
...
class RPNHead(nn.Module):
    ...
    def _get_proposals_single(self, rpn_cls_score, rpn_bbox_pred, rpn_dir_pred, anchors, anchor_mask, img_meta, cfg):
        ...
        # from disprcnn.modeling.sassd_module.models.single_stage_heads.ssd_rotate_head import rotate_nms
